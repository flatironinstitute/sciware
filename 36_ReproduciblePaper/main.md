...
-  <!-- .element: class="fragment" --> <a href="https://github.com/billbrod/foveated-metamers/?tab=readme-ov-file#foveated-metamers">Example readme</a>
...
- Specify tested python versions and OS. <!-- .element: class="fragment" -->
-  <!-- .element: class="fragment" --> <a href="https://github.com/billbrod/foveated-metamers/?tab=readme-ov-file#setup">Example readme</a>
...
- <!-- .element: class="fragment" -->  Examples:  <a href="https://github.com/billbrod/foveated-metamers/?tab=readme-ov-file#citation">1</a>, <a href="https://github.com/billbrod/spatial-frequency-preferences/blob/main/README.md#citation">2</a>
...
- Processed data <!-- .element: class="fragment supplemental"  -->
- Model parameters <!-- .element: class="fragment supplemental" -->
-  <!-- .element: class="fragment supplemental"  --> Stand-alone outputs (<a href="https://users.flatironinstitute.org/~wbroderick/metamers/">e.g.,</a>)
...
<div data-animate data-load="assets/data_standards.svg">
<!-- {"setup": [
{"element": "#g4", "modifier": "attr", "parameters": [ {"class": "fragment"} ]}
]} -->
</div>
...
- Archive checklist (from Vicky Rampin at NYU):  <!-- .element: class="fragment" -->
...
- Archived versions at immutable... <!-- .element: class="fragment" -->
- But you can always update files and release new version  <!-- .element: class="fragment" -->
...
- Tell people how to download and where to place data.
- Script the download and arrangement of your data. <!-- .element class="supplemental" -->
...
- <!-- .element: class="fragment supplemental"  --> Zenodo can automatically archive github repositories and give them DOIs (<a href="https://zenodo.org/records/13851768">e.g.</a>)
- Not only archives code, but also makes it citable.<!-- .element: class="fragment supplemental"  -->
- <!-- .element: class="fragment supplemental"  --> See <a href="https://docs.github.com/en/repositories/archiving-a-github-repository/referencing-and-citing-content">instructions</a>.
...
Not just for software packages!<!-- .element: class="supplemental" -->
- <!-- .element: class="fragment supplemental" --> Can do through GitHub's web UI (<a href="https://github.com/billbrod/spatial-frequency-preferences">e.g.</a>). 
- Use versioning to mark milestones (e.g., "presentation at Cosyne", "preprint", "journal submission", "final accepted version") <!-- .element: class="fragment supplemental" -->
- Version your data too!  <!-- .element: class="fragment supplemental" -->
...
- How do I convert the data into figures?
  - Firstly, code should be modular (i.e, not just a single script or notebook that does everything). <!-- .element: class="fragment" -->
- Explain how to run your pipeline (pick one): <!-- .element: class="fragment" -->
...
- Allows you to determine if dependencies change in breaking way. <!-- .element: class="fragment supplemental" -->
- Does add some maintenance load, but may save you time in long run. <!-- .element: class="fragment supplemental" -->
...
- Ideally, people will not need to read your source code to run it.<!-- .element: class="supplemental" -->
- Code is read far more often than it's written. <!-- .element: class="fragment supplemental" -->
- <!-- .element: class="fragment supplemental" --> See <a href="https://docs.google.com/presentation/d/1H7F0KiPMhNC79QxoBZiY4-xiIEdF8GWQ_XsLyE_Bygk/edit#slide=id.p3">Jeff Soules's presentation from FWAM</a>
- Consider using linters and formatters (e.g., ruff, black, flake8). <!-- .element: class="fragment supplemental" -->
...
- Reproducibility is not a binary outcome and is something we can all improve at over time. <!-- .element: class="fragment" -->
- Guiding principles: <!-- .element: class="fragment" -->
  - Get the code working on different machines.  <!-- .element: class="fragment" -->
  - Describe what the code does and how to use it.  <!-- .element: class="fragment" -->
  - Make setting up and running the workflow as easy as possible. <!-- .element: class="fragment" -->
- <!-- .element: class="fragment" --> Anything is better than nothing &mdash; good luck!
- Ask for help!  <!-- .element: class="fragment" -->
